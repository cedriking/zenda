...
const INJECTION_PATTERNS: Array<{ regex: RegExp; flag: string }> = [
  {
    ...
    flag: "ignore_previous",
  },
  { regex: /ignore\s+(all\s+)?above/i, flag: "ignore_above" },
  {
    regex: /disregard\s+(your\s+)?instructions/i,
    flag: "disregard_instructions",
  },
  ...
  { regex: /<system>/i, flag: "system_tag" },
  {
    regex: /forget\s+(your|the)\s+(instructions|rules|prompt)/i,
    flag: "forget_instructions",
  },
