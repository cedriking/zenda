...
import { ComposioClient, type CalendarEvent } from '../client'
...
describe('ComposioClient', () => {
  ...
  describe('handleCallback', () => {
    it('should complete connection with valid code', async () => {
      const result = await client.handleCallback('sess-123', 'auth-code-123', 'workspace-123')
  ...
  describe('updateEvent', () => {
    it('should update an existing event', async () => {
      ...
      const result = await client.updateEvent('workspace-123', 'evt-123', updates)
