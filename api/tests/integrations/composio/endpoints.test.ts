...
describe('Composio API Endpoints', () => {
  ...
  beforeEach(() => {
    ...
    app = new Elysia()
      .get('/integrations/composio/connect/:workspaceId', async ({ params }) => {
      ...
      .get('/integrations/composio/events/:workspaceId', async ({ params, query }) => {
        const workspaceId = params.workspaceId
      ...
      .post('/integrations/composio/events/:workspaceId', async ({ params, body }) => {
        const workspaceId = params.workspaceId
        const result = await composioClient.createEvent(workspaceId, body as any)
        return result
      })
      .patch('/integrations/composio/events/:workspaceId/:eventId', async ({ params, body }) => {
        const workspaceId = params.workspaceId
        const eventId = params.eventId
        const result = await composioClient.updateEvent(workspaceId, eventId, body as any)
        return result
      })
      .delete('/integrations/composio/events/:workspaceId/:eventId', async ({ params }) => {
        const workspaceId = params.workspaceId
        const eventId = params.eventId
      ...
      .delete('/integrations/composio/disconnect/:workspaceId', async ({ params }) => {
        const workspaceId = params.workspaceId
  ...
  describe('POST /integrations/composio/connect', () => {
    test('should return connection URL for valid workspace', async () => {
      ...
      const response = await app
        .handle(new Request(`http://localhost/integrations/composio/connect/${workspaceId}`))
        .then((res) => res.json())
  ...
  describe('GET /integrations/composio/callback', () => {
    test('should process OAuth callback successfully', async () => {
      ...
      const response = await app.handle(new Request(url)).then((res) => res.json())
  ...
  describe('GET /integrations/composio/events', () => {
    test('should list events for a date range', async () => {
      ...
      const url = new URL(`http://localhost/integrations/composio/events/${workspaceId}`)
  ...
  describe('POST /integrations/composio/events', () => {
    test('should create a new calendar event', async () => {
      ...
      const response = await app
        .handle(
          new Request(`http://localhost/integrations/composio/events/${workspaceId}`, {
            method: 'POST',
  ...
  describe('GET /integrations/composio/status/:workspaceId', () => {
    test('should return connection status for workspace', async () => {
      ...
      const response = await app
        .handle(new Request(`http://localhost/integrations/composio/status/${workspaceId}`))
        .then((res) => res.json())
  ...
  describe('DELETE /integrations/composio/disconnect/:workspaceId', () => {
    test('should disconnect a connected account', async () => {
      ...
      const response = await app
        .handle(
          new Request(`http://localhost/integrations/composio/disconnect/${workspaceId}`, {
            method: 'DELETE',
          })
        )
        .then((res) => res.json())
  ...
  describe('Authentication Guards', () => {
    test('should reject requests without valid authentication', async () => {
      ...
      const response = await app
        .handle(
          new Request(`http://localhost/integrations/composio/connect/${workspaceId}`, {
            headers: {
    ...
    test('should validate workspace ID belongs to authenticated user', async () => {
      ...
      const response = await app
        .handle(
          new Request(`http://localhost/integrations/composio/status/${workspaceId}`, {
            headers: {
