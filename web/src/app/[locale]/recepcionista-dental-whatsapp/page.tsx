      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Zenda — Recepcionista Dental WhatsApp",
        },
      ],
    },
  };
...
const PAIN_POINTS = [
  {
    icon: Clock,
    text: "Pacientes que escriben fuera de horario y no reciben respuesta",
  },
  {
    icon: Phone,
    text: "Tu personal atendiendo WhatsApp en vez de tratar pacientes",
  },
...
const FEATURES = [
  {
    title: "Agenda citas de limpieza, blanqueamiento y más",
    desc: "Configura todos tus tratamientos dentales con duración y precio. La IA agenda automáticamente según disponibilidad.",
  },
  {
    title: "Responde consultas de tratamientos y precios",
    desc: "Información precisa sobre servicios, costos y planes de pago — directamente en WhatsApp.",
  },
  {
    title: "Recordatorios para reducir inasistencias",
    desc: "Recordatorios automáticos 24h y 2h antes. Las clínicas dentales reducen inasistencias hasta un 40%.",
  },
  {
    title: "Maneja múltiples dentistas",
    desc: "Cada dentista con su propia agenda. La IA verifica disponibilidad de cada profesional en tiempo real.",
  },
  {
    title: "Funciona en español y portugués",
    desc: "Perfecto para clínicas en México, Colombia, Argentina, Brasil y toda Latinoamérica.",
  },
  {
    title: "Integración con tu sistema actual",
    desc: "Sincroniza citas con Google Calendar, Outlook y los principales sistemas de gestión dental.",
  },
];

const FAQS = [
  {
    q: "¿Cómo ayuda Zenda a una clínica dental?",
    a: "Zenda responde automáticamente los mensajes de WhatsApp de tus pacientes. Agenda citas para limpiezas, blanqueamientos, ortodoncia y más. Envía recordatorios y confirma turnos — sin que tu personal tenga que estar pendiente del teléfono.",
  },
  {
    q: "¿Puede manejar citas para varios dentistas?",
    a: "Sí. Cada dentista tiene su propia agenda en Zenda. La IA verifica la disponibilidad de cada profesional y asigna la cita al dentista correcto según el tratamiento.",
  },
  {
    q: "¿Funciona con seguros dentales?",
    a: "Puedes configurar la información de seguros dental que aceptas. La IA informa al paciente sobre cobertura y requisitos de aprobación.",
  },
  {
    q: "¿Cuánto cuesta para una clínica dental?",
    a: "El plan gratuito incluye hasta 25 contactos mensuales. Los planes pagados empiezan desde $29 USD/mes por local. Ofrecemos 50% de descuento a las primeras clínicas.",
  },
  {
    q: "¿Cuánto tiempo toma configurar?",
    a: "5 minutos. Conectas tu WhatsApp Business, defines tus tratamientos, horarios y dentistas. La IA empieza a responder de inmediato.",
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-4xl px-6 pt-20 pb-16 text-center">
        ...
        <h1 className="mb-6 font-bold text-4xl text-slate-900 leading-tight md:text-5xl">
          Tu clínica dental atiende{" "}
          <span className="text-emerald-600">pacientes por WhatsApp 24/7</span>
        </h1>
        <p className="mx-auto mb-8 max-w-2xl text-lg text-slate-600">
          Recepcionista virtual que agenda citas, responde consultas sobre
          tratamientos y confirma turnos automáticamente por WhatsApp. Sin
      ...
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mb-6 text-slate-500">
            Empieza gratis con hasta 25 contactos. Para clínicas más grandes,
