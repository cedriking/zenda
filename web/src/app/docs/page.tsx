  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">By default, all conversations are in <strong>auto mode</strong>. Your AI receptionist handles the entire conversation: greeting, answering questions, checking availability, and booking appointments.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">When the AI escalates, the conversation shows an orange &quot;Needs Attention&quot; badge. You&apos;ll see a notification in the top bar. Click the conversation to review what happened and decide whether to take over or let the AI continue.</p>
            </div>
          </div>
        </section>
        ...
        {/* Customizing Your AI */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold mb-6">Customizing Your AI</h2>
          <div className="space-y-6">
            <div>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            <p className="text-muted-foreground">All plans include a 14-day free trial. No credit card required to start.</p>
