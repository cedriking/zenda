...
export const updateBusinessProfileSchema = z.object({
  ...
  category: z
    .enum(["beauty", "wellness", "health", "coaching", "fitness", "other"] as [
      BusinessCategory,
      ...BusinessCategory[],
    ])
    .optional(),
...
export const updateReceptionistProfileSchema = z.object({
  ...
  tone: z
    .enum(["professional", "warm", "friendly", "elegant", "casual"] as [
      ReceptionistTone,
      ...ReceptionistTone[],
    ])
    .optional(),
...
>;
export type UpdateReceptionistProfileInput = z.infer<
  typeof updateReceptionistProfileSchema
>;
