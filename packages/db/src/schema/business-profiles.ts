...
export const priceDisplayEnum = pgEnum("price_display", [
  "show",
  "hide",
  "on_request",
]);
...
export const businessProfiles = pgTable("business_profiles", {
  ...
  priceDisplayPreference: priceDisplayEnum("price_display_preference")
    .notNull()
    .default("show"),
  cancellationWindowHours: integer("cancellation_window_hours")
    .notNull()
    .default(24),
  reschedulingWindowHours: integer("rescheduling_window_hours")
    .notNull()
    .default(2),
  minimumNoticeHours: integer("minimum_notice_hours").notNull().default(2),
  maximumBookingWindowDays: integer("maximum_booking_window_days")
    .notNull()
    .default(30),
  ...
  escalationBehavior: jsonb("escalation_behavior")
    .$type<{
      autoPauseAi?: boolean;
  ...
  ownerNotificationPreferences: jsonb("owner_notification_preferences")
    .$type<{
...
export const receptionistProfiles = pgTable("receptionist_profiles", {
  ...
  proactivelySuggestTimes: boolean("proactively_suggest_times")
    .notNull()
    .default(true),
  confirmsBeforeBooking: boolean("confirms_before_booking")
    .notNull()
    .default(true),
  notifyOwnerEveryAppointment: boolean("notify_owner_every_appointment")
    .notNull()
    .default(true),
  cancellationPolicyStrictness: cancellationStrictnessEnum(
    "cancellation_policy_strictness"
  )
    .notNull()
    .default("standard"),
