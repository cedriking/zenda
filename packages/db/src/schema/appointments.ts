...
export const reminderStatusEnum = pgEnum("appointment_reminder_status", [
  "none",
  "scheduled",
  "sent",
  "confirmed",
...
export const appointments = pgTable(
  ...
  (table) => [
    index("appointments_workspace_date_idx").on(
      table.workspaceId,
      table.startAt
    ),
    index("appointments_workspace_status_idx").on(
      table.workspaceId,
      table.status
    ),
    index("appointments_confirmation_status_idx").on(
      table.workspaceId,
