...
export const workspaces = pgTable("workspaces", {
  ...
  composioConnectedAt: timestamp("composio_connected_at", {
    withTimezone: true,
  }),
  // Messaging config (§9, §10)
  maxRemindersPerAppointment: integer("max_reminders_per_appointment")
    .notNull()
    .default(2),
  maxOutboundWithoutReply: integer("max_outbound_without_reply")
    .notNull()
    .default(3),
  outboundLimitsConfig: jsonb("outbound_limits_config")
